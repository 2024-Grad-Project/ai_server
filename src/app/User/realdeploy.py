...
# Setup the client
client = FHEModelClient(path_dir=fhe_directory, key_dir="/home/giuk/keys_client_nsfw_1_Dec/")
...
image_path = '/var/www/api-server-node/api-server-node/src/app/User/images/10.jpg'
...
image_path_for_check = '/var/www/api-server-node/api-server-node/src/app/User/images/10.jpg'
...
constant_input = torch.tensor([[args.arg]], dtype=torch.float32)
